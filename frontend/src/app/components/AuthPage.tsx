    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center gap-2 justify-center mb-8">
          ...
          <span className="font-semibold text-xl">EdgeDeploy</span>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border border-white/10 rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Sign in to continue to EdgeDeploy</p>
          </div>
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full bg-white text-black px-6 py-3 rounded-lg hover:bg-gray-100 transition-colors flex items-center justify-center gap-3"
            >
            ...
            <button
              ...
              className="w-full bg-white/10 border border-white/20 text-white px-6 py-3 rounded-lg hover:bg-white/20 transition-colors flex items-center justify-center gap-3"
            >
          ...
          <div className="space-y-4 mb-6">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-3 rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
            >
          ...
          <p className="text-xs text-center text-gray-500">
            By continuing, you agree to EdgeDeploy's{' '}
        ...
        <div className="mt-8 text-center">
          ...
          <div className="flex items-center justify-center gap-8 opacity-50">
            ...
            <div className="text-gray-600 font-semibold">Tesla</div>
